"""
This currently only works on Linux systems with xorg.

I am looking to port this on more systems later
...
class UploadThread(QThread):
    ...
    def run(self):
        ...
        try:            
            ...
            with tempfile.NamedTemporaryFile(mode='w', suffix='.csv', delete=False, encoding='utf-8') as csv_tmp:
    ...
    def populate_windows(self):
        ...
        for window_id in window_ids:
            try:
                ...
                if name_prop:
                    name = name_prop.value.decode('utf-8') if isinstance(name_prop.value, bytes) else str(name_prop.value)
                    item_text = f"{name} (ID: {window_id})"
...
class DataCollector(QMainWindow):
    ...
    def __init__(self):
        ...
        self.server_url = "https://locked-concentrate-medicines-incentives.trycloudflare.com" # This is the URL to our server
    ...
    def on_pynput_press(self, key):
        try:
            ...
            if hasattr(focus, 'id') and focus.id == self.selected_window['id']:
    ...
    def check_idle(self):
        if self.is_collecting:
            ...
            if idle_time >= self.idle_threshold:
                ...
                self.active_keys.clear() # Clear keys if we go AFK for 5 seconds or longer
